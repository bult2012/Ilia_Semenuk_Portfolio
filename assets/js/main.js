...
const sendMail = () => {
  const mailAddress = "awsome.ilia2012@gmail.com"
  const subject = encodeURIComponent(document.getElementById('validationCustomFirstName').value + " " + document.getElementById('validationCustomLastName').value)
  const body = encodeURIComponent(document.getElementById('validationCustomMessage').value + "\n" + document.getElementById('validationCustomEmail').value)
  const link = `mailto:${mailAddress}?&subject=${subject}&body=${body}`
  window.location.href = link;
}

const openMail = () => {
  const mailAddress = "awsome.ilia2012@gmail.com"
  const link = `mailto:${mailAddress}?`
  window.location.href = link;
}
